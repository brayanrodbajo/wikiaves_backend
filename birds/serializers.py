...
#
#     def create(self, validated_data):
#         size_shape = validated_data.pop('description', None)
#         if size_shape:
...
#
#     def update(self, instance, validated_data):
#         size_shape = validated_data.get('description', None)
#         if size_shape:
#             serializer = TextSerializer(instance.description, data=size_shape)
#             if serializer.is_valid():
#                 size_shape = serializer.save()
#                 instance.description = size_shape
#             else:
#                 print(serializer.errors)
